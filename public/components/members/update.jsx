...
class UpdateMember extends React.Component {
    ...
    componentDidMount() {
        axios.get('/api/member/' + this.props.match.params.id)
          .then(res => {
              this.setState({ 
                  form_id: res.data.id,
                  form_first_name: res.data.first_name,
                  form_last_name: res.data.last_name,
                  form_email: res.data.email,
                  form_phone: res.data.phone,
                  form_resume: res.data.resume_url,
                  form_pronoun: res.data.pronoun,
                  form_school: res.data.school,
                  form_year: res.data.year,
                  form_degree: res.data.degree,
                  form_type: res.data.member_type
            })
          })
    }
    ...
    handleSubmit(evt) {
        ...
        axios({
            method: 'put',
            url: '/api/member/' + this.props.match.params.id,
            data: formData,
